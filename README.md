# CursoBootstrap
Curso completado de Bootstrap - Platzi

Web:
https://crisospina.github.io/CursoBootstrap/

Resumen
* Framework Front-End o Framework Css
  - Son una base para inicializar un proyecto web permitiendo flexibilidad en el diseño. Brindan organización y estructura 
    para los archivos html, css y javascript.
...
* Hay varias formas de jugar con bootstrap:
  - Llamando el url mediante las etiquetas link (css) y js (script) en el html.
  - Descargar los archivos css y js y guardarlos en la carpeta de nuestro proyecto.
  - Instalandolo mediante el CDN que sale en la documentación
...
* Grilla
  ...
  - El sistema de grillas de Bootstrap usa una serie de contenedores, filas y columnas para diseñar y alinear el contenido. 

* Al crear un diseño en Bootstrap hay que tener presente, su lema de mobile-first sites, diseña desde móvil hacia dispositivos
  mas grandes.


* object-fit: es una propiedad que permite preservar la relacion de aspecto de la imagen, ocupando tantos espacios como sea posible                   ajustandose al tamaño de su contenedor. 
...
* Plugins interesantes para Bootstrap 3 algunas ya se encuentran actualizados para Bootstrap 4:
  ...
  Bootstrap Image Gallery es una solución muy completa para crear galerías de 
  imágenes en Bootstrap. Después de incluir los archivos necesarios en tu página, 
  ...
  para esa tarea. Además, el diseño de los tags puede personalizarse al 100% y 
